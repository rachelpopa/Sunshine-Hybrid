sap.ui.define([], function () {
        ...
        return {
            ...
            getFormattedTemperature : function (temperature) {
                return Math.floor(temperature) +'\xB0';
            },

            getFormattedHumidity : function (humidity) {
                return humidity + " %";
            },
            
            getFormattedPressure : function (pressure) {
                return Math.round(pressure) + " hPa";
            },
            
            getFormattedWind : function (speed, deg) {
